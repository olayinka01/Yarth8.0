...
(function($) {
    ...
    jQuery(document).ready(function () {
        ...
        // !!!!!!!!! Flickr Demo
        var instagram_module = jQuery('#instagram_module');
        var flickr_img_url = 'img/flickr/index.html';
        var flickr_wrap = jQuery('.flickr_widget_wrapper');
        if (flickr_wrap.size() > 0) {
            var flickr_cont = '<div class="flickr_badge_image"><a href="javascript:void(0);"><img src="'+flickr_img_url+'1.jpg" alt=""><div class="flickr_fadder"></div></a></div><div class="flickr_badge_image"><a href="javascript:void(0);"><img src="'+flickr_img_url+'2.jpg" alt=""><div class="flickr_fadder"></div></a></div><div class="flickr_badge_image"><a href="javascript:void(0);"><img src="'+flickr_img_url+'3.jpg" alt=""><div class="flickr_fadder"></div></a></div><div class="flickr_badge_image"><a href="javascript:void(0);"><img src="'+flickr_img_url+'4.jpg" alt=""><div class="flickr_fadder"></div></a></div><div class="flickr_badge_image"><a href="javascript:void(0);"><img src="'+flickr_img_url+'5.jpg" alt=""><div class="flickr_fadder"></div></a></div><div class="flickr_badge_image"><a href="javascript:void(0);"><img src="'+flickr_img_url+'6.jpg" alt=""><div class="flickr_fadder"></div></a></div><div class="flickr_badge_image"><a href="javascript:void(0);"><img src="'+flickr_img_url+'7.jpg" alt=""><div class="flickr_fadder"></div></a></div><div class="flickr_badge_image"><a href="javascript:void(0);"><img src="'+flickr_img_url+'8.jpg" alt=""><div class="flickr_fadder"></div></a></div><div class="flickr_badge_image"><a href="javascript:void(0);"><img src="'+flickr_img_url+'9.jpg" alt=""><div class="flickr_fadder"></div></a></div><div class="flickr_badge_image"><a href="javascript:void(0);"><img src="'+flickr_img_url+'10.jpg" alt=""><div class="flickr_fadder"></div></a></div><div class="flickr_badge_image"><a href="javascript:void(0);"><img src="'+flickr_img_url+'11.jpg" alt=""><div class="flickr_fadder"></div></a></div><div class="flickr_badge_image"><a href="javascript:void(0);"><img src="'+flickr_img_url+'12.jpg" alt=""><div class="flickr_fadder"></div></a></div>';
            flickr_wrap.each(function () {
                jQuery(this).append(flickr_cont);
            });
        }

        // !!!!!!!!! Instagram Demo
        if (instagram_module.size() > 0) {
            var instagram_cont = '<a href="javascript:void(0);"><img src="'+flickr_img_url+'instagram1.jpg" alt=""></a><a href="javascript:void(0);"><img src="'+flickr_img_url+'instagram2.jpg" alt=""></a><a href="javascript:void(0);"><img src="'+flickr_img_url+'instagram3.jpg" alt=""></a><a href="javascript:void(0);"><img src="'+flickr_img_url+'instagram4.jpg" alt=""></a><a href="javascript:void(0);"><img src="'+flickr_img_url+'instagram5.jpg" alt=""></a><a href="javascript:void(0);"><img src="'+flickr_img_url+'instagram6.jpg" alt=""></a><a href="javascript:void(0);"><img src="'+flickr_img_url+'instagram7.jpg" alt=""></a><a href="javascript:void(0);"><img src="'+flickr_img_url+'instagram8.jpg" alt=""></a>';
            instagram_module.append(instagram_cont);
        }
