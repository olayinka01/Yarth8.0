...
<!-- BREAKCRUMB -->
		...
		<section class="login-register">
			<div class="container">
				<div class="row">
					...
					{{ Form::open(array('url' => 'postRemind','method' => 'post', 'class'=>'form login ')) }}
						
                        <center> <span style="color:red;font-weight:bold;"> @if (Session::has('error'))
          {{ Session::get('error') }}</span></center>
        ...
        @endif
                        ...
                        {{ Form::submit('Send', array('class'=>'btn btn-13 btn-submit')) }}
                        </footer>
