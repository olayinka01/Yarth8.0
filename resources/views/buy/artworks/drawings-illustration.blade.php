                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            <li>			
                                    ...
                                    <ul class="nav-cat">
                                        ...
                                        <li>
                                            <a class="current-menu" href="{{URL::to('buy/artworks/drawings-illustration')}}">{{$menucate->cat_name}}</a>
                                            <ul class="nav-cat">
                                                ...
                                                @endforeach
                                                 ...
                                                 @foreach($menusubcate38 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/drawings-illustration/fountains-waterfalls')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubcate39 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/drawings-illustration/science-technology')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubcate40 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/drawings-illustration/other-drawings-illustration')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
