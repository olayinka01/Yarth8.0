                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            <li>			
                                    ...
                                    <ul class="nav-cat">
                                        ...
                                        <li>
                                            <a class="current-menu" href="{{URL::to('buy/artworks/crafts-otherarts')}}">{{$menucate->cat_name}}</a>
                                            <ul class="nav-cat">
                                            
                                                @foreach($menusubcate41 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/crafts-otherarts/basketry')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                        
                                                 @foreach($menusubcate42 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/crafts-otherarts/beadwork')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                        
                                                 @foreach($menusubcate43 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/crafts-otherarts/birdhouses-birdcages')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubcate44 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/crafts-otherarts/birdfeeders')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubcate45 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/crafts-otherarts/boxes')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubcate46 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/crafts-otherarts/candles')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubcate47 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/crafts-otherarts/leathercraft')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubcate48 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/crafts-otherarts/toys')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubcate49 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/crafts-otherarts/other-craft-arts')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
