                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            <li>			
                                    ...
                                    <ul class="nav-cat">
                                        ...
                                        <li>
                                            <a class="current-menu" href="{{URL::to('buy/artworks/sculptures-carvings')}}">{{$menucate->cat_name}}</a>
                                            <ul class="nav-cat">
                                            
                                                @foreach($menusubcate1 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/sculptures-carvings/abstract')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                ...
                                                @endforeach
                                                 ...
                                                 @foreach($menusubcate5 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/sculptures-carvings/fountains-waterfalls')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubcate6 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/sculptures-carvings/science-technology')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubcate7 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/sculptures-carvings/other-sculptures-carvings')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
