...
@section('title')
Yarth: Crafts & Other Art/Birdhouses-Birdcages
@yield('title')
@stop
                            ...
                            @endforeach
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav-cat">
                                                ...
                                                <li>
                                                    <a class="current-menu" href="{{URL::to('buy/artworks/crafts-otherarts/birdhouses-birdcages')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
