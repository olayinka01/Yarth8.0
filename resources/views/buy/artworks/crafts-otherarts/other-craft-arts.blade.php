...
@section('title')
Yarth: Crafts & Other Art/Other Crafts-Other-Arts
@yield('title')
@stop
                            ...
                            @endforeach
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav-cat">
                                                ...
                                                <li>
                                                    <a class="current-menu" href="{{URL::to('buy/artworks/crafts-otherarts/other-craft-arts')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
