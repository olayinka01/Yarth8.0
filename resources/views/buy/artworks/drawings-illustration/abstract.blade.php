...
@section('title')
Yarth: Drawings & Illustration/Abstract
@yield('title')
@stop
                            ...
                            @endforeach
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav-cat">
                                                ...
                                                <li>
                                                    <a class="current-menu" href="{{URL::to('buy/artworks/drawings-illustration/abstract')}}">{{$menusubcate->subcat_name}}</a>
                                                    
                                                        <ul class="nav-cat">
                                                        
                                                            @foreach($menusubsubcate85 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/abstract/collage')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                              @foreach($menusubsubcate86 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/abstract/colour')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                        
                                                             @foreach($menusubsubcate87 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/abstract/figurative')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate88 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/abstract/geometric')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate89 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/abstract/irregular-forms')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate90 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/abstract/landscape')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate91 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/abstract/man-made-objects')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                            @foreach($menusubsubcate92 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/abstract/movement')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                             @foreach($menusubsubcate93 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/abstract/text')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate94 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/abstract/organic')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                             @foreach($menusubsubcate95 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/abstract/other-abstract')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
