...
@section('title')
Yarth: Drawings & Illustration/Other Drawings-Illustration
@yield('title')
@stop
                            ...
                            @endforeach
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav-cat">
                                                ...
                                                <li>
                                                    <a class="current-menu" href="{{URL::to('buy/artworks/drawings-illustration/other-drawings-illustration')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
