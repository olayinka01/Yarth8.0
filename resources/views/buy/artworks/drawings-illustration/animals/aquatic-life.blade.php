...
@section('title')
Yarth: Drawings & Illustration/Animals/Aquatic Life
@yield('title')
@stop
        		...
        		<div class="row">
                    ...
                    <div class="col-md-3">
                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            @foreach($menusubcate35 as $menusubcate)
                            <li>
                                <a  href="{{URL::to('buy/artworks/drawings-illustration/animals')}}">< {{$menusubcate->subcat_name}}</a>
                                <ul class="nav-cat">
                                
                                    
                                        @foreach($menusubsubcate96 as $menusubsubcate)
                                        <li>
                                            <a class="current-menu"  href="{{URL::to('buy/artworks/drawings-illustration/animals/aquatic-life/')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                            
                                            <ul class="nav-cat">
                                                
                                                @foreach($menusubsubsubcate127 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/drawings-illustration/animals/aquatic-life/dolphins')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubsubsubcate128 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/drawings-illustration/animals/aquatic-life/fish')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubsubsubcate129 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/drawings-illustration/animals/aquatic-life/manatee')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubsubsubcate130 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/drawings-illustration/animals/aquatic-life/seals')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubsubsubcate131 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/drawings-illustration/animals/aquatic-life/crustaceans')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubsubsubcate132 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/drawings-illustration/animals/aquatic-life/other-aquatic-life')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
