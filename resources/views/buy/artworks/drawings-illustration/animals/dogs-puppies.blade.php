...
@section('title')
Yarth: Drawings & Illustration/Animals/Dogs-Puppies
@yield('title')
@stop
                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate99 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/drawings-illustration/animals/dogs-puppies')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                
                                                <ul class="nav-cat">
                                                    
                                                    @foreach($menusubsubsubcate144 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/animals/dogs-puppies/akita')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate145 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/animals/dogs-puppies/dalmatian')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate146 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/animals/dogs-puppies/french-bulldog')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate147 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/animals/dogs-puppies/pug')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                     @foreach($menusubsubsubcate148 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/animals/dogs-puppies/other-dogs-puppies')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
