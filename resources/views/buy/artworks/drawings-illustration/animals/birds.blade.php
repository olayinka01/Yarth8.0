...
@section('title')
Yarth: Drawings & Illustration/Animals/Birds
@yield('title')
@stop
                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                        ...
                                        @foreach($menusubsubcate97 as $menusubsubcate)
                                        <li>
                                            <a class="current-menu"  href="{{URL::to('buy/artworks/drawings-illustration/animals/birds')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                            
                                            <ul class="nav-cat">
                                                
                                                @foreach($menusubsubsubcate133 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/drawings-illustration/animals/birds/eagles')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubsubsubcate134 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/drawings-illustration/animals/birds/flamingo')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubsubsubcate135 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/drawings-illustration/animals/birds/ducks-loons')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubsubsubcate136 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/drawings-illustration/animals/birds/hawk')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubsubsubcate137 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/drawings-illustration/animals/birds/peacock')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubsubsubcate138 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/drawings-illustration/animals/birds/other-birds')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
