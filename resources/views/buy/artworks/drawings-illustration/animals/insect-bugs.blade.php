...
@section('title')
Yarth: Drawings & Illustration/Animals/Insect-Bugs
@yield('title')
@stop
                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                        ...
                                        @foreach($menusubsubcate98 as $menusubsubcate)
                                        <li>
                                            <a class="current-menu"  href="{{URL::to('buy/artworks/drawings-illustration/animals/insect-bugs')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                            
                                            <ul class="nav-cat">
                                                
                                                @foreach($menusubsubsubcate139 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/drawings-illustration/animals/insect-bugs/ant')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubsubsubcate140 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/drawings-illustration/animals/insect-bugs/bee-wasp')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubsubsubcate141 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/drawings-illustration/animals/insect-bugs/dragonfly')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubsubsubcate142 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/drawings-illustration/animals/insect-bugs/beetles')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubsubsubcate143 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/drawings-illustration/animals/insect-bugs/other-insect-bugs')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
