...
@section('title')
Yarth: Drawings & Illustration/Flowers-Plants-Trees/Flowers
@yield('title')
@stop
        		...
        		<div class="row">
                    ...
                    <div class="col-md-3">
                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            @foreach($menusubcate37 as $menusubcate)
                            <li>
                                <a  href="{{URL::to('buy/artworks/drawings-illustration/flowers-plants-trees')}}">< {{$menusubcate->subcat_name}}</a>
                                <ul class="nav-cat">
                                
                                     @foreach($menusubsubcate111 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/drawings-illustration/flowers-plants-trees/flowers')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                
                                                <ul class="nav-cat">
                                                    
                                                    @foreach($menusubsubsubcate171 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/flowers-plants-trees/flowers/lilies')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate172 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/flowers-plants-trees/flowers/roses')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate173 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/flowers-plants-trees/flowers/tulips')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate174 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/flowers-plants-trees/flowers/wisteria')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                     @foreach($menusubsubsubcate175 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/flowers-plants-trees/flowers/angelica')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate176 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/flowers-plants-trees/flowers/other-flowers')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
