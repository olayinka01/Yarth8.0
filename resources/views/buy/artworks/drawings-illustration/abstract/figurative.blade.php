...
@section('title')
Yarth: Drawings & Illustration/Abstract/Figurative
@yield('title')
@stop
                                    ...
                                    <li>
                                        <a  href="{{URL::to('buy/artworks/drawings-illustration/abstract')}}">< {{$menusubcate->subcat_name}}</a>
                                        	...
                                        	<ul class="nav-cat">
                            					...
                            					<li>
                                					<a class="current-menu"  href="{{URL::to('buy/artworks/drawings-illustration/abstract/colour')}}">{{$menusubsubcate->subsubcat_name}}</a>
                            					@endforeach
