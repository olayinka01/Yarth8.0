...
@section('title')
Yarth: Drawings & Illustration/Abstract/Other Abstract
@yield('title')
@stop
                                    ...
                                    <li>
                                        <a  href="{{URL::to('buy/artworks/drawings-illustration/abstract')}}">< {{$menusubcate->subcat_name}}</a>
                                        	...
                                        	<ul class="nav-cat">
                            					...
                            					<li>
                                					<a class="current-menu"  href="{{URL::to('buy/artworks/drawings-illustration/abstract/other-abstract')}}">{{$menusubsubcate->subsubcat_name}}</a>
                            					@endforeach
