...
@section('title')
Yarth: Drawings & Illustration/Ethnic-Cultural-Tribal
@yield('title')
@stop
                            ...
                            @endforeach
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav-cat">
                                                ...
                                                <li>
                                                    <a class="current-menu" href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal')}}">{{$menusubcate->subcat_name}}</a>
                                                    
                                                        <ul class="nav-cat">
                                                        
                                                            @foreach($menusubsubcate102 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                        
                                                             @foreach($menusubsubcate103 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/african')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate104 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/americana')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate105 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/asian-indian')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate106 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/egyptian')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate107 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/italian')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                             @foreach($menusubsubcate108 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/mexican')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                              @foreach($menusubsubcate109 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/russian')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                              @foreach($menusubsubcate123 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/british')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                             @foreach($menusubsubcate110 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/others')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
