...
@section('title')
Yarth: Drawings & Illustration/Science-Technology
@yield('title')
@stop
                            ...
                            @endforeach
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav-cat">
                                                ...
                                                @foreach($menusubcate39 as $menusubcate)
                                                <li>
                                                    <a class="current-menu" href="{{URL::to('buy/artworks/drawings-illustration/science-technology')}}">{{$menusubcate->subcat_name}}</a>
                                                    
                                                        <ul class="nav-cat">
                                                        
                                                            @foreach($menusubsubcate115 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/science-technology/ecology')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                        
                                                             @foreach($menusubsubcate116 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/science-technology/energy')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate117 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/science-technology/history')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate118 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/science-technology/medicine')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate119 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/science-technology/people')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate120 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/science-technology/research')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                             @foreach($menusubsubcate121 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/science-technology/space')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                             @foreach($menusubsubcate122 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/science-technology/others')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
