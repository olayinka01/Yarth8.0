...
@section('title')
Yarth: Drawings & Illustration/Flowers-Plants-Trees
@yield('title')
@stop
                            ...
                            @endforeach
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav-cat">
                                                ...
                                                <li>
                                                    <a class="current-menu" href="{{URL::to('buy/artworks/drawings-illustration/flowers-plants-trees')}}">{{$menusubcate->subcat_name}}</a>
                                                    
                                                        <ul class="nav-cat">
                                                        
                                                            @foreach($menusubsubcate111 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/flowers-plants-trees/flowers')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                        
                                                             @foreach($menusubsubcate112 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/flowers-plants-trees/plants')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate113 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/flowers-plants-trees/trees')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                             @foreach($menusubsubcate114 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/flowers-plants-trees/others')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
