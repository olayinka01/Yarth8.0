...
@section('title')
Yarth: Drawings & Illustration/Animals
@yield('title')
@stop
                            ...
                            @endforeach
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav-cat">
                                                ...
                                                <li>
                                                    <a class="current-menu" href="{{URL::to('buy/artworks/drawings-illustration/animals')}}">{{$menusubcate->subcat_name}}</a>
                                                    
                                                        <ul class="nav-cat">
                                                        
                                                            @foreach($menusubsubcate96 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/animals/aquatic-life')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                        
                                                             @foreach($menusubsubcate97 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/animals/birds')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate98 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/animals/insect-bugs')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate99 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/animals/dogs-puppies')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate100 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/animals/farm-animals')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                             @foreach($menusubsubcate101 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/drawings-illustration/animals/other-animals')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
