...
@section('title')
Yarth: Drawings & Illustration/Ethnic-Cultural-Tribal/Nigerian
@yield('title')
@stop
        		...
        		<div class="row">
                    ...
                    <div class="col-md-3">
                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            @foreach($menusubcate36 as $menusubcate)
                            <li>
                                <a  href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal')}}">< {{$menusubcate->subcat_name}}</a>
                                <ul class="nav-cat">
                                
                                     @foreach($menusubsubcate102 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                
                                                <ul class="nav-cat">
                                                    
                                                    @foreach($menusubsubsubcate153 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/yoruba-society-people')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate154 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/igbo-society-people')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate155 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/hausa-society-people')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate156 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/fulani-society-people')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                     @foreach($menusubsubsubcate157 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/ibibio-society-people')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate158 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/tiv-society-people')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate159 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/nigerian-textiles-drawings')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate160 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/nigerian-tribal-masks')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                     @foreach($menusubsubsubcate161 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/other-nigerian')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
