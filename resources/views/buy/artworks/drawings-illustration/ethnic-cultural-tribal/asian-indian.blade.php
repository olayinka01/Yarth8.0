...
@section('title')
Yarth: Drawings & Illustration/Ethnic-Cultural-Tribal/Asian-Indian
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate105 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/asian-indian')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                
                                                <ul class="nav-cat">
                                                    
                                                    @foreach($menusubsubsubcate166 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/asian-indian/indian')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate167 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/asian-indian/chinese')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate168 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/asian-indian/japanese')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate169 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/asian-indian/thai')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                     @foreach($menusubsubsubcate170 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/asian-indian/other-asian-indian')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
