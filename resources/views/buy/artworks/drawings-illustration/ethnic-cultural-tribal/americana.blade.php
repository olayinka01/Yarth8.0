...
@section('title')
Yarth: Drawings & Illustration/Ethnic-Cultural-Tribal/Americana
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate104 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/drawings-illustration/ethnic-cultural-tribal/americana')}}">{{$menusubsubcate->subsubcat_name}}</a>      
                                           </li>
                                           @endforeach
