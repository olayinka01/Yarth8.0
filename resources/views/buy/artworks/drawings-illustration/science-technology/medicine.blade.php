...
@section('title')
Yarth: Drawings & Illustration/Science-Technology/Medicine
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate118 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/drawings-illustration/science-technology/medicine')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
