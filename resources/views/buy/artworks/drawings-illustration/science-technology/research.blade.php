...
@section('title')
Yarth: Drawings & Illustration/Science-Technology/Research
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate120 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/drawings-illustration/science-technology/research')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
