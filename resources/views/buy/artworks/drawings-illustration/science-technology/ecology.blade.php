...
@section('title')
Yarth: Drawings & Illustration/Science-Technology/Ecology
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate115 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/drawings-illustration/science-technology/ecology')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
