...
@section('title')
Yarth: Drawings & Illustration/Science-Technology/People
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate119 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/drawings-illustration/science-technology/people')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
