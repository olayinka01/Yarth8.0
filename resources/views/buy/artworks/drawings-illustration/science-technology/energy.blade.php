...
@section('title')
Yarth: Drawings & Illustration/Science-Technology/Energy
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate116 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/drawings-illustration/science-technology/energy')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
