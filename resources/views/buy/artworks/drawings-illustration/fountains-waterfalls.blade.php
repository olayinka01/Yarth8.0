...
@section('title')
Yarth: Drawings & Illustration/Fountains-Waterfalls
@yield('title')
@stop
                            ...
                            @endforeach
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav-cat">
                                                ...
                                                <li>
                                                    <a class="current-menu" href="{{URL::to('buy/artworks/drawings-illustration/fountains-waterfalls')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
