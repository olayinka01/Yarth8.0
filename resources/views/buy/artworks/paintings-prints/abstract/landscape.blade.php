...
@section('title')
Yarth:Paintings & Prints/Abstract/Landscape
@yield('title')
@stop
                                    ...
                                    <li>
                                        <a  href="{{URL::to('buy/artworks/paintings-prints/abstract')}}">< {{$menusubcate->subcat_name}}</a>
                                        	...
                                        	<ul class="nav-cat">
                            					...
                            					<li>
                                					<a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/abstract/landscape')}}">{{$menusubsubcate->subsubcat_name}}</a>
                            					@endforeach
