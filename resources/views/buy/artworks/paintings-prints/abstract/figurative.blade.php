...
@section('title')
Yarth:Paintings & Prints/Abstract/Figurative
@yield('title')
@stop
                                    ...
                                    <li>
                                        <a  href="{{URL::to('buy/artworks/paintings-prints/abstract')}}">< {{$menusubcate->subcat_name}}</a>
                                        	...
                                        	<ul class="nav-cat">
                            					...
                            					<li>
                                					<a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/abstract/figurative')}}">{{$menusubsubcate->subsubcat_name}}</a>
                            					@endforeach
