...
@section('title')
Yarth: Paintings & Prints/Flowers-Plants-Trees
@yield('title')
@stop
                            ...
                            @endforeach
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav-cat">
                                                ...
                                                <li>
                                                    <a class="current-menu" href="{{URL::to('buy/artworks/paintings-prints/flowers-plants-trees')}}">{{$menusubcate->subcat_name}}</a>
                                                    
                                                        <ul class="nav-cat">
                                                        
                                                            @foreach($menusubsubcate54 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/flowers-plants-trees/flowers')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                        
                                                             @foreach($menusubsubcate55 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/flowers-plants-trees/plants')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate56 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/flowers-plants-trees/trees')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
