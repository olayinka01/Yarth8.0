...
@section('title')
Yarth: Paintings & Printings/Flowers-Plants-Trees/Flowers/Other Flowers
@yield('title')
@stop
		...
		<header class="header _2">
            ...
            <div class="container">
				...
				<div class="header-cn clearfix">
					...
					<!-- LOGO -->
					<div class="logo">
						<a href="../plants/flowers/index.html"><img src="{{URL::asset('images/logo-mine.png')}}" alt=""></a>
					</div>
					<!-- END LOGO -->
                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                    ...
                                    <li>
                                        <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/flowers-plants-trees/flowers/other-flowers')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                    </li>
                                    @endforeach
