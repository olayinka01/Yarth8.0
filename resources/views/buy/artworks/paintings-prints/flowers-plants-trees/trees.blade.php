...
@section('title')
Yarth: Paintings & Prints/Flowers-Plants-Trees/Trees
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate56 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/flowers-plants-trees/trees')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
