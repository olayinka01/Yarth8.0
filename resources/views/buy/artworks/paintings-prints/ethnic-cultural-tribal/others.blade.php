...
@section('title')
Yarth: Paintings & Prints/Ethnic-Cultural-Tribal/Others
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate71 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/others')}}">{{$menusubsubcate->subsubcat_name}}</a>      
                                           </li>
                                           @endforeach
