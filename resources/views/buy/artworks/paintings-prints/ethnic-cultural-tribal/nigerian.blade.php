...
@section('title')
Yarth: Paintings & Prints/Ethnic-Cultural-Tribal/Nigerian
@yield('title')
@stop
        		...
        		<div class="row">
                    ...
                    <div class="col-md-3">
                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            <li>
                                <a  href="{{URL::to('buy/artworks/paintings-prints')}}">< {{$menucate->cat_name}}</a>
                            @endforeach
                                
                            @foreach($menusubcate22 as $menusubcate)
                            <li>
                                <a  href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal')}}">< {{$menusubcate->subcat_name}}</a>
                                <ul class="nav-cat">
                                
                                     @foreach($menusubsubcate62 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                
                                                <ul class="nav-cat">
                                                    
                                                    @foreach($menusubsubsubcate109 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/yoruba-society-people')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate110 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/igbo-society-people')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate111 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/hausa-society-people')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate112 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/fulani-society-people')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                     @foreach($menusubsubsubcate113 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/ibibio-society-people')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate114 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/tiv-society-people')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate115 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/nigerian-textiles-paintings')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate116 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/nigerian-tribal-masks')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                     @foreach($menusubsubsubcate117 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/other-nigerian')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
