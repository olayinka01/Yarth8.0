...
@section('title')
Yarth: Paintings & Prints/Ethnic-Cultural-Tribal/Russian
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate70 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/russian')}}">{{$menusubsubcate->subsubcat_name}}</a>      
                                           </li>
                                           @endforeach
