...
@section('title')
Yarth: Paintings & Prints/Ethnic-Cultural-Tribal/Mexican
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate69 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/mexican')}}">{{$menusubsubcate->subsubcat_name}}</a>      
                                           </li>
                                           @endforeach
