...
@section('title')
Yarth: Paintings & Prints/Ethnic-Cultural-Tribal/Asian-Indian
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate66 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/asian-indian')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                
                                                <ul class="nav-cat">
                                                    
                                                    @foreach($menusubsubsubcate122 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/asian-indian/indian')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate123 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/asian-indian/chinese')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate124 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/asian-indian/japanese')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate125 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/asian-indian/thai')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                     @foreach($menusubsubsubcate126 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/asian-indian/other-asian-indian')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
