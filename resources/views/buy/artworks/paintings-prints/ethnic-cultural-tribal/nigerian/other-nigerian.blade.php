...
@section('title')
Yarth: Paintings & Prints/Ethnic-Cultural-Tribal/Nigerian/Other Nigerian
@yield('title')
@stop
                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                    ...
                                    <li>
                                        <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/other-nigerian')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                    </li>
                                    @endforeach
