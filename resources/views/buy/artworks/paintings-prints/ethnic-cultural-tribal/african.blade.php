...
@section('title')
Yarth: Paintings & Prints/Ethnic-Cultural-Tribal/African
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate63 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/african')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                
                                                <ul class="nav-cat">
                                                    
                                                    @foreach($menusubsubsubcate118 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/african/african-society-people')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate119 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/african/african-textiles-paintings')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate120 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/african/african-tribal-masks')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                     @foreach($menusubsubsubcate121 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/african/other-african')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
