...
@section('title')
Yarth: Paintings & Prints/Other Paintings-Prints
@yield('title')
@stop
                            ...
                            @endforeach
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav-cat">
                                                ...
                                                <li>
                                                    <a class="current-menu" href="{{URL::to('buy/artworks//paintings-prints/other-paintings-prints')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
