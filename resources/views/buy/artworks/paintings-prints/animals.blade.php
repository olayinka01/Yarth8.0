...
@section('title')
Yarth: Paintings & Prints/Animals
@yield('title')
@stop
                                                ...
                                                <li>
                                                    <a class="current-menu" href="{{URL::to('buy/artworks/sculptures-carvings/animals')}}">{{$menusubcate->subcat_name}}</a>
                                                        ...
                                                        <ul class="nav-cat">
                                                            ...
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/animals/aquatic-life')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                        
                                                             @foreach($menusubsubcate49 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/animals/birds')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate50 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/animals/insect-bugs')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate51 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/animals/dogs-puppies')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate52 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/animals/farm-animals')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate53 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/animals/other-animals')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
