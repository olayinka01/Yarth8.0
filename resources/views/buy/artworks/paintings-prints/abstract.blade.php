...
@section('title')
Yarth: Paintings & Prints/Abstract
@yield('title')
@stop
                            ...
                            @endforeach
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav-cat">
                                                ...
                                                @foreach($menusubcate18 as $menusubcate)
                                                <li>
                                                    <a class="current-menu" href="{{URL::to('buy/artworks/sculptures-carvings/abstract')}}">{{$menusubcate->subcat_name}}</a>
                                                    
                                                        <ul class="nav-cat">
                                                        
                                                            @foreach($menusubsubcate38 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/abstract/collage')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                        
                                                             @foreach($menusubsubcate39 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/abstract/colour')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate40 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/abstract/figurative')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate41 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/abstract/geometric')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate42 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/abstract/irregular-forms')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate43 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/abstract/landscape')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                             @foreach($menusubsubcate44 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/abstract/man-made-objects')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate45 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/abstract/text')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                             @foreach($menusubsubcate46 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/abstract/organic')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate47 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/abstract/other-abstract')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
