...
@section('title')
Yarth: Paintings & Prints/People Figures/Occupations
@yield('title')
@stop
		...
		<header class="header _2">
            ...
            <div class="container">
				...
				<div class="header-cn clearfix">
					...
					<!-- LOGO -->
					<div class="logo">
						<a href="../peope-figures/index.html"><img src="{{URL::asset('images/logo-mine.png')}}" alt=""></a>
					</div>
					<!-- END LOGO -->
        		...
        		<div class="row">
                    ...
                    <div class="col-md-3">
                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            @foreach($menusubcate21 as $menusubcate)
                            <li>
                                <a  href="{{URL::to('buy/artworks/paintings-prints/people-figures')}}">< {{$menusubcate->subcat_name}}</a>
                                <ul class="nav-cat">
                                
                                     @foreach($menusubsubcate60 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/people-figures/occupations')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                
                                                <ul class="nav-cat">
                                                    
                                                    @foreach($menusubsubsubcate99 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/people-figures/occupations/actor')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate100 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/people-figures/occupations/astronaut')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate101 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/people-figures/occupations/chef')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate102 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/people-figures/occupations/doctor-dentists')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate103 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/people-figures/occupations/musician')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate104 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/people-figures/occupations/other-occupations')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
