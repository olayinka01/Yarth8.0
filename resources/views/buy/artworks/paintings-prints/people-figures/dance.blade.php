...
@section('title')
Yarth: Paintings & Prints/People Figures/Dance
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate58 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/people-figures/dance')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
