...
@section('title')
Yarth: Paintings & Printings/People Figures/Potrait/Other-Potrait
@yield('title')
@stop
		...
		<header class="header _2">
            ...
            <div class="container">
				...
				<div class="header-cn clearfix">
					...
					<!-- LOGO -->
					<div class="logo">
						<a href="../../animals/index.html"><img src="{{URL::asset('images/logo-mine.png')}}" alt=""></a>
					</div>
					<!-- END LOGO -->
                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                    ...
                                    <li>
                                        <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/people-figures/potrait/other-potrait')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                    </li>
                                    @endforeach
