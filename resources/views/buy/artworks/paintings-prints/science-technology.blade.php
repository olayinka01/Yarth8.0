...
@section('title')
Yarth: Paintings & Prints/Science-Technology
@yield('title')
@stop
                            ...
                            @endforeach
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav-cat">
                                                ...
                                                @foreach($menusubcate23 as $menusubcate)
                                                <li>
                                                    <a class="current-menu" href="{{URL::to('buy/artworks/paintings-prints/science-technology')}}">{{$menusubcate->subcat_name}}</a>
                                                    
                                                        <ul class="nav-cat">
                                                        
                                                            @foreach($menusubsubcate72 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/science-technology/ecology')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                        
                                                             @foreach($menusubsubcate73 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/science-technology/energy')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate74 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/science-technology/history')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate75 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/science-technology/medicine')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate76 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/science-technology/people')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                            @endforeach
                                                            
                                                            @foreach($menusubsubcate77 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/science-technology/research')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                            @endforeach
                                                             
                                                             @foreach($menusubsubcate78 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/science-technology/space')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate79 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/science-technology/others')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
