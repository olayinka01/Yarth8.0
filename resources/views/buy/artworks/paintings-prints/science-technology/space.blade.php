...
@section('title')
Yarth: Paintings & Prints/Science-Technology/Space
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate78 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/science-technology/space')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
