...
@section('title')
Yarth: Paintings & Prints/Science-Technology/Others
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate79 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/science-technology/others')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
