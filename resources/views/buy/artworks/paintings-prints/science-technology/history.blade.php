...
@section('title')
Yarth: Paintings & Prints/Science-Technology/History
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate74 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/science-technology/history')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
