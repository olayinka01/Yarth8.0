...
@section('title')
Yarth: Paintings & Prints/Science-Technology/People
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate76 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/science-technology/people')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
