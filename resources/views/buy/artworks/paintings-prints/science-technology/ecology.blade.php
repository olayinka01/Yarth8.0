...
@section('title')
Yarth: Paintings & Prints/Science-Technology/Ecology
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate72 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/science-technology/ecology')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
