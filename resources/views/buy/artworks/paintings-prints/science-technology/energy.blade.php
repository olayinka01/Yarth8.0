...
@section('title')
Yarth: Paintings & Prints/Science-Technology/Energy
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate73 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/science-technology/energy')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
