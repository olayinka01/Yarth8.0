...
@section('title')
Yarth: Paintings & Prints/Science-Technology/Research
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate77 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/science-technology/research')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
