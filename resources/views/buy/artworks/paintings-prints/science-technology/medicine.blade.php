...
@section('title')
Yarth: Paintings & Prints/Science-Technology/Medicine
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate75 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/science-technology/medicine')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
