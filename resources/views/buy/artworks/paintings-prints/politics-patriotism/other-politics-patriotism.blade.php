...
@section('title')
Yarth: Paintings & Prints/Politics-Patriotism/Other-Politics-Patriotism
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate84 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/politics-patriotism/other-politics-patriotism')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
