...
@section('title')
Yarth: Paintings & Prints/Politics-Patriotism/Military-War
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate82 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/politics-patriotism/military-war')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
