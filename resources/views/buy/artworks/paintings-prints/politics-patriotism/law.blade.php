...
@section('title')
Yarth: Paintings & Prints/Politics-Patriotism/Law
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate81 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/politics-patriotism/law')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
