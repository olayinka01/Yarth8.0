...
@section('title')
Yarth: Paintings & Prints/Politics-Patriotism/Flags-Symbols
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate80 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/politics-patriotism/flags-symbols')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
