...
@section('title')
Yarth: Paintings & Prints/Politics-Patriotism/Politics
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate83 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/politics-patriotism/politics')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
