...
@section('title')
Yarth: Paintings & Prints/Ethnic-Cultural-Tribal
@yield('title')
@stop
                            ...
                            @endforeach
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav-cat">
                                                ...
                                                <li>
                                                    <a class="current-menu" href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal')}}">{{$menusubcate->subcat_name}}</a>
                                                    
                                                        <ul class="nav-cat">
                                                        
                                                            @foreach($menusubsubcate62 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                        
                                                             @foreach($menusubsubcate63 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/african')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate64 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/british')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate65 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/americana')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate66 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/asian-indian')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                             @foreach($menusubsubcate67 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/egyptian')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate68 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/italian')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                             @foreach($menusubsubcate69 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/mexican')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate70 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/russian')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                             @foreach($menusubsubcate71 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/paintings-prints/ethnic-cultural-tribal/others')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
