...
@section('title')
Yarth: Paintings & Prints/Animals/Aquatic Life
@yield('title')
@stop
        		...
        		<div class="row">
                    ...
                    <div class="col-md-3">
                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            @foreach($menusubcate19 as $menusubcate)
                            <li>
                                <a  href="{{URL::to('buy/artworks/paintings-prints/animals')}}">< {{$menusubcate->subcat_name}}</a>
                                <ul class="nav-cat">
                                
                                    
                                        @foreach($menusubsubcate48 as $menusubsubcate)
                                        <li>
                                            <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/animals/aquatic-life')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                            
                                            <ul class="nav-cat">
                                                
                                                @foreach($menusubsubsubcate55 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/paintings-prints/animals/aquatic-life/dolphins')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubsubsubcate56 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/paintings-prints/animals/aquatic-life/fish')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubsubsubcate57 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/paintings-prints/animals/aquatic-life/manatee')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubsubsubcate58 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/paintings-prints/animals/aquatic-life/seals')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubsubsubcate59 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/paintings-prints/animals/aquatic-life/crustaceans')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubsubsubcate60 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/paintings-prints/animals/aquatic-life/other-aquatic-life')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
