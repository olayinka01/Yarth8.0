...
@section('title')
Yarth: Paintings & Prints/Animals/Other Animals
@yield('title')
@stop
                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                            ...
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/animals/other-animals')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                            </li>
                                            @endforeach      
