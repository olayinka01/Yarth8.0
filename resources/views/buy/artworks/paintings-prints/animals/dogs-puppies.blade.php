...
@section('title')
Yarth: Paintings & Prints/Animals/Dogs-Puppies
@yield('title')
@stop
                            ...
                            <li>
                                <a  href="{{URL::to('buy/artworks/paintings-prints/animals')}}">< {{$menusubcate->subcat_name}}</a>
                            		<ul class="nav-cat">
                                     		...
                                     		@foreach($menusubsubcate51 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/paintings-prints/animals/dogs-puppies')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                
                                                <ul class="nav-cat">
                                                    
                                                    @foreach($menusubsubsubcate72 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/animals/dogs-puppies/akita')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate73 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/animals/dogs-puppies/dalmatian')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate74 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/animals/dogs-puppies/french-bulldog')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate75 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/animals/dogs-puppies/pug')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                     @foreach($menusubsubsubcate76 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/paintings-prints/animals/dogs-puppies/other-dogs-puppies')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
