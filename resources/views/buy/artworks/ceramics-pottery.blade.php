                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            <li>			
                                    ...
                                    <ul class="nav-cat">
                                        ...
                                        <li>
                                            <a class="current-menu" href="{{URL::to('buy/artworks/ceramics-pottery')}}">{{$menucate->cat_name}}</a>
                                            <ul class="nav-cat">
                                            
                                                @foreach($menusubcate8 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/ceramics-pottery/bowls-pots')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                        
                                                 @foreach($menusubcate9 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/ceramics-pottery/candle-holders')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                        
                                                 @foreach($menusubcate10 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/ceramics-pottery/childrens-art')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubcate11 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/ceramics-pottery/cups-goblets')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubcate12 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/ceramics-pottery/fountains-waterfalls')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubcate13 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/ceramics-pottery/jars')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubcate14 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/ceramics-pottery/jewelry')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubcate15 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/ceramics-pottery/tiles')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubcate16 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/ceramics-pottery/vases-urns')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubcate17 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/ceramics-pottery/other-ceramics-pottery')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
