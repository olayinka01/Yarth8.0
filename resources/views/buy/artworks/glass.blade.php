                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            <li>			
                                    ...
                                    <ul class="nav-cat">
                                        ...
                                        <li>
                                            <a class="current-menu" href="{{URL::to('buy/artworks/glass')}}">{{$menucate->cat_name}}</a>
                                            <ul class="nav-cat">
                                            
                                                @foreach($menusubcate26 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/glass/bead')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                        
                                                 @foreach($menusubcate27 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/glass/bowls-pots')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                        
                                                 @foreach($menusubcate28 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/glass/candle-holders')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubcate29 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/glass/jars')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubcate30 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/glass/jewelry')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubcate31 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/glass/mirrors')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubcate32 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/glass/vases-urns')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubcate33 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/glass/other-glass')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
