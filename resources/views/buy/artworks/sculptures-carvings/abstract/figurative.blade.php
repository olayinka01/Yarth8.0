...
@section('title')
Yarth: Scultures & Carvings/Abstract/Figurative
@yield('title')
@stop
                                    ...
                                    <li>
                                        <a  href="{{URL::to('buy/artworks/sculptures-carvings/abstract')}}">< {{$menusubcate->subcat_name}}</a>
                                        	...
                                        	<ul class="nav-cat">
                            					...
                            					<li>
                                					<a class="current-menu"  href="{{URL::to('buy/artworks/sculptures-carvings/abstract/figurative')}}">{{$menusubsubcate->subsubcat_name}}</a>
                            					@endforeach
