...
@section('title')
Yarth: Sculptures-Carvings/Science-Technology
@yield('title')
@stop
                            ...
                            @endforeach
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav-cat">
                                                ...
                                                @foreach($menusubcate6 as $menusubcate)
                                                <li>
                                                    <a class="current-menu" href="{{URL::to('buy/artworks/sculptures-carvings/science-technology')}}">{{$menusubcate->subcat_name}}</a>
                                                    
                                                        <ul class="nav-cat">
                                                        
                                                            @foreach($menusubsubcate31 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/science-technology/ecology')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                        
                                                             @foreach($menusubsubcate32 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/science-technology/space')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate33 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/science-technology/history')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate34 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/science-technology/medicine')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate35 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/science-technology/people')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate36 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/science-technology/research')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                             @foreach($menusubsubcate37 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/science-technology/others')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
