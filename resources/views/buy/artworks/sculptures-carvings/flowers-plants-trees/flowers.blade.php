...
@section('title')
Yarth: Sculptures & Carvings/Flowers-Plants-Trees/Flowers
@yield('title')
@stop
        		...
        		<div class="row">
                    ...
                    <div class="col-md-3">
                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            @foreach($menusubcate4 as $menusubcate)
                            <li>
                                <a  href="{{URL::to('buy/artworks/sculptures-carvings/flowers-plants-trees')}}">< {{$menusubcate->subcat_name}}</a>
                                <ul class="nav-cat">
                                
                                     @foreach($menusubsubcate27 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                
                                                <ul class="nav-cat">
                                                    
                                                    @foreach($menusubsubsubcate45 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers/lilies')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate46 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers/roses')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate47 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers/tulips')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate48 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers/wisteria')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                     @foreach($menusubsubsubcate49 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers/angelica')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate50 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers/other-flowers')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
