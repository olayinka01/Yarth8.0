...
@section('title')
Yarth: Scultures & Carvings/Ethnic-Cultural-Tribal/African
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate18 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/african')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                
                                                <ul class="nav-cat">
                                                    
                                                    @foreach($menusubsubsubcate36 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/african/african-society-people')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate37 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/african/african-textiles-sculptures')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate38 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/african/african-tribal-masks')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                     @foreach($menusubsubsubcate39 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/african/other-african')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
