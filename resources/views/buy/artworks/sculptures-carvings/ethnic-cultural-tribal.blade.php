...
@section('title')
Yarth: Sculptures-Carvings/Ethnic-Cultural-Tribal
@yield('title')
@stop
                            ...
                            @endforeach
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav-cat">
                                                ...
                                                <li>
                                                    <a class="current-menu" href="{{URL::to('buy/artworks/sculptures-carvings/ethnic-cultural-tribal')}}">{{$menusubcate->subcat_name}}</a>
                                                    
                                                        <ul class="nav-cat">
                                                        
                                                            @foreach($menusubsubcate17 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/nigerian')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                        
                                                             @foreach($menusubsubcate18 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/african')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate19 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/british')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate20 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/americana')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate21 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/asian-indian')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate22 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/egyptian')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                             @foreach($menusubsubcate23 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/italian')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate24 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/mexican')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                             @foreach($menusubsubcate25 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/russian')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate26 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/others')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
