...
@section('title')
Yarth: Sculptures-Carvings/Flower-Plant-Tree
@yield('title')
@stop
                            ...
                            @endforeach
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav-cat">
                                                ...
                                                <li>
                                                    <a class="current-menu" href="{{URL::to('buy/artworks/sculptures-carvings/flowers-plants-trees')}}">{{$menusubcate->subcat_name}}</a>
                                                    
                                                        <ul class="nav-cat">
                                                        
                                                            @foreach($menusubsubcate27 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                        
                                                             @foreach($menusubsubcate28 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/flowers-plants-trees/plants')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate29 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/flowers-plants-trees/trees')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate30 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/flowers-plants-trees/others')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
