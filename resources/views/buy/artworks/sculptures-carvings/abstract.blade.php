...
@section('title')
Yarth: Sculptures-Carvings/Abstract
@yield('title')
@stop
                            ...
                            @endforeach
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav-cat">
                                                ...
                                                @foreach($menusubcate1 as $menusubcate)
                                                <li>
                                                    <a class="current-menu" href="{{URL::to('buy/artworks/sculptures-carvings/abstract')}}">{{$menusubcate->subcat_name}}</a>
                                                    
                                                        <ul class="nav-cat">
                                                        
                                                            @foreach($menusubsubcate1 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/abstract/collage')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                        
                                                             @foreach($menusubsubcate2 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/abstract/colour')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate3 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/abstract/figurative')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate4 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/abstract/geometric')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate5 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/abstract/irregular-forms')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate6 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/abstract/landscape')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                             @foreach($menusubsubcate7 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/abstract/man-made-objects')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate8 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/abstract/text')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                             
                                                             @foreach($menusubsubcate9 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/abstract/organic')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate10 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/abstract/other-abstract')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
