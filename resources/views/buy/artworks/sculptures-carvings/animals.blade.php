...
@section('title')
Yarth: Sculptures-Carvings/Animals
@yield('title')
@stop
                            ...
                            @endforeach
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav-cat">
                                                ...
                                                <li>
                                                    <a class="current-menu" href="{{URL::to('buy/artworks/sculptures-carvings/animals')}}">{{$menusubcate->subcat_name}}</a>
                                                    
                                                        <ul class="nav-cat">
                                                        
                                                            @foreach($menusubsubcate11 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/aquatic-life')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                        
                                                             @foreach($menusubsubcate12 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/birds')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate13 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/insect-bugs')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate14 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/dogs-puppies')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                             @foreach($menusubsubcate15 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/farm-animals')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
                                                            
                                                            @foreach($menusubsubcate16 as $menusubsubcate)
                                                            <li>
                                                            <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/other-animals')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                            </li>
                                                             @endforeach
