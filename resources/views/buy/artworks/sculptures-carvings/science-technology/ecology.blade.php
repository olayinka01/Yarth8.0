...
@section('title')
Yarth: Sculptures & Carvings/Science-Technology/Ecology
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate31 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/sculptures-carvings/science-technology/ecology')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
