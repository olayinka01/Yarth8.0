...
@section('title')
Yarth: Sculptures & Carvings/Science-Technology/Medicine
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate34 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/sculptures-carvings/science-technology/medicine')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
