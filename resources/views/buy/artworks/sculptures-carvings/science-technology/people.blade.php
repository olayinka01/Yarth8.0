...
@section('title')
Yarth: Sculptures & Carvings/Science-Technology/People
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate35 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/sculptures-carvings/science-technology/People')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                           </li>
                                           @endforeach
