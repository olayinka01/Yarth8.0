...
@section('title')
Yarth: Scultures & Carvings/Animals/Dogs-Puppies
@yield('title')
@stop
                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate14 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/sculptures-carvings/animals/dogs-puppies')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                
                                                <ul class="nav-cat">
                                                    
                                                    @foreach($menusubsubsubcate18 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/dogs-puppies/akita')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate19 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/dogs-puppies/dalmatian')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate20 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/dogs-puppies/french-bulldog')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate21 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/dogs-puppies/pug')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                     @foreach($menusubsubsubcate22 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/dogs-puppies/other-dogs-puppies')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
