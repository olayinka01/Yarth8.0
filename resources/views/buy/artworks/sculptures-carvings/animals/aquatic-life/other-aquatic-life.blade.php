...
@section('title')
Yarth: Sculptures & Carvings/Animals/Aquatic Life/Other Aquatic Life
@yield('title')
@stop
                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                    ...
                                    <li>
                                        <a class="current-menu"  href="{{URL::to('buy/artworks/sculptures-carvings/animals/aquatic-life/other-aquatic-life')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                    </li>
                                    @endforeach
