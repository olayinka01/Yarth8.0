...
@section('title')
Yarth: Scultures & Carvings/Animals/Birds
@yield('title')
@stop
                            ...
                            <li>
                                <a  href="{{URL::to('buy/artworks/sculptures-carvings/animals')}}">< {{$menusubcate->subcat_name}}</a>
                            		<ul class="nav-cat">
                                     		...
                                     		@foreach($menusubsubcate12 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/sculptures-carvings/animals/birds')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                
                                                <ul class="nav-cat">
                                                    
                                                    @foreach($menusubsubsubcate7 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/birds/eagles')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate8 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/birds/flamingo')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate9 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/birds/ducks-loons')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate10 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/birds/hawk')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                     @foreach($menusubsubsubcate11 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/birds/peacock')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate12 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/birds/other-birds')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
