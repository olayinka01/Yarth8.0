...
@section('title')
Yarth: Scultures & Carvings/Animals/Aquatic Life
@yield('title')
@stop
        		...
        		<div class="row">
                    ...
                    <div class="col-md-3">
                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            @foreach($menusubcate2 as $menusubcate)
                            <li>
                                <a  href="{{URL::to('buy/artworks/sculptures-carvings/animals')}}">< {{$menusubcate->subcat_name}}</a>
                                <ul class="nav-cat">
                                
                                    
                                        @foreach($menusubsubcate11 as $menusubsubcate)
                                        <li>
                                            <a class="current-menu"  href="{{URL::to('buy/artworks/sculptures-carvings/animals/aquatic-life')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                            
                                            <ul class="nav-cat">
                                                
                                                @foreach($menusubsubsubcate1 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/aquatic-life/dolphins')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubsubsubcate2 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/aquatic-life/fish')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubsubsubcate3 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/aquatic-life/manatee')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubsubsubcate4 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/aquatic-life/seals')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubsubsubcate5 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/aquatic-life/crustaceans')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubsubsubcate6 as $menusubsubsubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/aquatic-life/other-aquatic-life')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                </li>
                                                @endforeach
