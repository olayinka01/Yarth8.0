...
@section('title')
Yarth: Scultures & Carvings/Animals/Farm Animals
@yield('title')
@stop
                            ...
                            <li>
                                ...
                                <ul class="nav-cat">
                                     ...
                                     @foreach($menusubsubcate15 as $menusubsubcate)
                                            <li>
                                                <a class="current-menu"  href="{{URL::to('buy/artworks/sculptures-carvings/animals/farm-animals')}}">{{$menusubsubcate->subsubcat_name}}</a>
                                                
                                                <ul class="nav-cat">
                                                    
                                                    @foreach($menusubsubsubcate23 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/farm-animals/chickens')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate24 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/farm-animals/cows-bulls')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate25 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/farm-animals/sheep')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
                                                    
                                                    @foreach($menusubsubsubcate26 as $menusubsubsubcate)
                                                    <li>
                                                        <a href="{{URL::to('buy/artworks/sculptures-carvings/animals/farm-animals/other-farm-animals')}}">{{$menusubsubsubcate->subsubsubcat_name}}</a>
                                                    </li>
                                                    @endforeach
