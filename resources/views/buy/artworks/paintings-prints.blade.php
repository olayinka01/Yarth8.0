                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            <li>			
                                    ...
                                    <ul class="nav-cat">
                                        ...
                                        <li>
                                            <a class="current-menu" href="{{URL::to('buy/artworks/paintings-prints')}}">{{$menucate->cat_name}}</a>
                                            <ul class="nav-cat">
                                            
                                                @foreach($menusubcate18 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/paintings-prints/abstract')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                ...
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/paintings-prints/science-technology')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                 @foreach($menusubcate24 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/paintings-prints/politics-patriotism')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
                                                
                                                @foreach($menusubcate25 as $menusubcate)
                                                <li>
                                                    <a href="{{URL::to('buy/artworks/paintings-prints/other-paintings-prints')}}">{{$menusubcate->subcat_name}}</a>
                                                </li>
                                                @endforeach
