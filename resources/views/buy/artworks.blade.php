                    ...
                    <div class="col-md-3">
                    	...
                    	<aside class="sidebar sidebar-cat _1" id="marginbottom20">
                            ...
                            <li>
                                ...
                                <li>			
										<a class="current-menu" href="{{URL::to('buy/artworks')}}">{{$menutype->cattype_name}}</a>
                                        ...
                                        <ul class="nav-cat">
                                        	...
                                        	<li>
                                            	<a href="{{URL::to('buy/artworks/ceramics-pottery')}}">{{$menucate->cat_name}}</a>
                                            </li>
                                            @endforeach
                                        	...
                                        	<li>
                                            	<a href="{{URL::to('buy/artworks/glass')}}">{{$menucate->cat_name}}</a>
                                            </li>
                                            @endforeach
                                        	...
                                        	<li>
                                            	<a href="{{URL::to('buy/artworks/crafts-otherarts')}}">{{$menucate->cat_name}}</a>
                                            </li>
                                            @endforeach
